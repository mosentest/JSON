...
public class ExamDBHelper extends SQLiteOpenHelper{
	...
	//数据库文件目标存放路径为系统默认位置，cn.mobile.safe是你的包名
	@SuppressLint("SdCardPath")
	//private static final String DB_PATH = "/data/data/con.example.json/databases/";
	//如果你想把数据库存放在SD卡的话
	...
	private static String DB_PATH = android.os.Environment
			...
			+ "/databases/";
	private static String DB_NAME = "problems.db";
	private static String ASSETS_NAME = "problems.db";
