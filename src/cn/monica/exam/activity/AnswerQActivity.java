...
public class AnswerQActivity extends FinalActivity implements OnClickListener{
	...
	private void initData(){
		...
		proList = proService.getGroupData("4");
	...
	public void onClick(View v) {
		...
		case R.id.btnFillAdd:
			boolean flag = proService.AddFavourite(proList.get(nowIndex).getId(), "4");
			if(flag){
